...
This repository documents a small set of private product builds. It is a portfolio overview, not a source-code release.

The write-ups focus on the problem, product decisions, system boundaries, and evidence of engineering judgment. They do not include proprietary source code, private data, credentials, customer or contact information, or deployment configuration.

## Projects

| Project | What it is | Read more |
| --- | --- | --- |
...
| Professional Portfolio | Portfolio website experiments for presenting experience, selected projects, writing, and learning. | [Overview](docs/professional-portfolio.md) |

## A note on access

The underlying source repositories remain private. If you would like to discuss a project in more detail, please open an issue here or contact me through GitHub.
